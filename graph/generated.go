...
func (ec *executionContext) field_Query_characters_args(ctx context.Context, rawArgs map[string]interface{}) (map[string]interface{}, error) {
	...
	if tmp, ok := rawArgs["cliqueType"]; ok {
		...
		arg0, err = ec.unmarshalNCliqueType2goᚑgraphqlᚋgraphᚋmodelᚐCliqueType(ctx, tmp)
		if err != nil {
			return nil, err
		}
	}
...
func (ec *executionContext) _Query_character(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	...
	res := resTmp.(*model.Character)
	fc.Result = res
	return ec.marshalOCharacter2ᚖgoᚑgraphqlᚋgraphᚋmodelᚐCharacter(ctx, field.Selections, res)
}
...
func (ec *executionContext) _Query_characters(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	...
	res := resTmp.([]*model.Character)
	fc.Result = res
	return ec.marshalOCharacter2ᚕᚖgoᚑgraphqlᚋgraphᚋmodelᚐCharacterᚄ(ctx, field.Selections, res)
}
...
func (ec *executionContext) marshalOCharacter2ᚕᚖgoᚑgraphqlᚋgraphᚋmodelᚐCharacterᚄ(ctx context.Context, sel ast.SelectionSet, v []*model.Character) graphql.Marshaler {
	if v == nil {
		return graphql.Null
	}
	ret := make(graphql.Array, len(v))
	...
	for i := range v {
		...
		f := func(i int) {
			...
			ret[i] = ec.marshalNCharacter2ᚖgoᚑgraphqlᚋgraphᚋmodelᚐCharacter(ctx, sel, v[i])
		}
		if isLen1 {
			f(i)
		} else {
...
func (ec *executionContext) marshalOCharacter2ᚖgoᚑgraphqlᚋgraphᚋmodelᚐCharacter(ctx context.Context, sel ast.SelectionSet, v *model.Character) graphql.Marshaler {
	if v == nil {
		return graphql.Null
	}
	return ec._Character(ctx, sel, v)
